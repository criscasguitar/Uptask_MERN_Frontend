  ...
  return (
    <>
      ...
      <form 
        ...
        <div>
          <label 
            className="uppercase text-gray-600 block text-xl font-bold mt-4"
            htmlFor="password"
          >
              Password
            </label>
        ...
        <input 
          ...
          className="bg-sky-700 w-full py-3 mt-5 mb-5 text-white uppercase font-bold rounded hover:cursor-pointer
